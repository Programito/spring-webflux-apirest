package com.progra.springboot.webflux.app.models.controllers;
...
public class ProductoController {
	...
	// sin RequestBody porque no puedes subir archivos en json
	@PostMapping("/v2")
...
//	}
	...
	public Mono<ResponseEntity<Flux<Producto>>> lista(){
		...
		// APPLICATION_JSON_UTF8 esta deprecated
		return Mono.just(
				ResponseEntity.ok()
				.contentType(MediaType.APPLICATION_JSON)
	...
	public Mono<ResponseEntity<Producto>> ver(@PathVariable String id){
		// build construye la respuesta sin contenido
	...
	// sin validar  @RequestBody Producto producto
...
//		);
	...
	public Mono<ResponseEntity<Map<String,Object>>> crear(@Valid @RequestBody Mono<Producto> monoProducto){
		...
		// para poder devolver producto o error ya no puede ser Mono<ResponseEntity<Producto>>
		...
		return monoProducto.flatMap(producto -> {
			...
			// WebExchangeBindException tipo mas concreto
			// mono a mono field error lista de errores
			// flatMapMany convertir a flux 
			// simplificar de fieldError a string
			// collectList volver a mono
			// Mono response entity de string y object
	...
	public Mono<ResponseEntity<Void>> eliminar(@PathVariable String id){
		 // flatMap porque devuelve un mono void
		// no content elimnado 204
		// no existe not found 404
		return service.findById(id).flatMap(p ->{
